...
module.exports = {
    ...
    run: async (client, message) => {
        ...
        if (!isAuthorAllowed && message.author.id !== db && !message.member.permissions.has(PermissionFlagsBits.Administrator) && !message.member.permissions.has(PermissionFlagsBits.ManageRoles) && !owners.includes(message.author.id) ) {
