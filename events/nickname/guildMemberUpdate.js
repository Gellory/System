...
module.exports = async (client, oldMember, newMember) => {
    ...
    oldMember.guild.fetchAuditLogs({ limit: 1, type: AuditLogEvent.MemberUpdate }).then(logs => {
        ...
        if (oldMember.nickname !== newMember.nickname) {
            ...
            let updateNickname = new Discord.EmbedBuilder()
                .setAuthor({ name: oldMember.user.tag, iconURL: oldMember.user.displayAvatarURL({ dynamic: true, size: 1024, format: 'png' }) })
