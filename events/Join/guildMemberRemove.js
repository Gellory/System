...
let leaveMember = new Discord.EmbedBuilder()
  .setAuthor({ name: member.user.username, iconURL: member.user.displayAvatarURL({ dynamic: true, size: 1024, format: 'png' }) })
      ...
      if (member.roles.cache.size > 1) { 
       ...
       leaveMember.addFields({ name: 'الأدوار السابقة', value: mentionedRoles.join(', ') });
    }
